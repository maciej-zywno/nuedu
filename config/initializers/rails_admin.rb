# RailsAdmin config file. Generated on January 15, 2014 15:58
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Nuedu', 'Admin']
  ...
  config.included_models = ['Answer', 'Course', 'Question', 'Step', 'Exam', 'User', 'Video', 'Attachment', 'Category', 'Role', 'Review']
